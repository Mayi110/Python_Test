...
def send_mail(report_path):
    ...
    #这里使用 简单邮件协议
    smtp=smtplib.SMTP()
    smtp.connect('sos88588@qq.com',25)
    smtp.login('sos88588@qq.com','mdtodnnwcfggfeji')#不是你的邮箱登录密码，而是你登录成功之后设置授权码
    smtp.sendmail('sos88588@qq.com','sos88588@qq.com',msg.as_string())
    smtp.quit()
    print ('邮件已发出！注意查收。')
